        ...
        <div className="flex flex-col items-center space-y-4 text-center">
          <div className="space-y-2">
            <h1 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl lg:text-6xl/none">
              Hi, I&apos;m <span className="gradient-text">Abhijith H Nair</span>
            </h1>
            <p className="mx-auto max-w-[700px] text-xl text-muted-foreground md:text-2xl">
              ...
              <noscript>
                <span>Senior Software Developer | Frontend Developer | JavaScript | TypeScript | NextJS </span>
              </noscript>
            </p>
          </div>
          ...
          <div className="flex gap-4 mt-6">
            <Button variant="ghost" size="icon" asChild>
              <Link href="https://github.com/abhijithnair123" target="_blank" rel="noopener noreferrer">
